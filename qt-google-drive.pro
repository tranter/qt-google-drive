...
SOURCES += network/webcontentmanager.cpp
SOURCES += network/computercontentmanager.cpp
...
HEADERS += network/webcontentmanager.h
HEADERS += network/computercontentmanager.h
